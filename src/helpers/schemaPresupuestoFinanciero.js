...
const schemaRegistroPresupuestoFinanciero = Joi.object({
  codigo: Joi.string()
    .required()
    .error((errors) => {
      errors.forEach((data) => {
...
const validateRegistroPresupuesto = validator(schemaRegistroPresupuestoFinanciero);
export { validateRegistroPresupuesto };
